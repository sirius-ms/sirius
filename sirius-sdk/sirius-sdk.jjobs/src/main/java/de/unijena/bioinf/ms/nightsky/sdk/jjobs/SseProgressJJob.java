...
public class SseProgressJJob extends WaiterJJob<Job> {
    ...
    public SseProgressJJob(SiriusClient siriusClient, String projectId, String jobId) {
        this(siriusClient, projectId, jobId, JobState.SUBMITTED);
    }

    public SseProgressJJob(SiriusClient siriusClient, String projectId, Job job) {
    ...
    public SseProgressJJob(SiriusClient siriusClient, String projectId, String jobId, JobState state) {
        super();
