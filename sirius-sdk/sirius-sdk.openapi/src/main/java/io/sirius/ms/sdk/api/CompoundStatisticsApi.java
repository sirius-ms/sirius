...
public class CompoundStatisticsApi {
    ...
    private ResponseSpec computeCompoundFoldChangesExperimentalRequestCreation(@jakarta.annotation.Nonnull String projectId, @jakarta.annotation.Nonnull FoldChangeJobSubmission foldChangeJobSubmission, @jakarta.annotation.Nullable List<JobOptField> optFields) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/api/projects/{projectId}/compounds/statistics/foldchange/compute", HttpMethod.PUT, pathParams, localVarQueryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    ...
    private ResponseSpec deleteCompoundFoldChangesExperimentalRequestCreation(@jakarta.annotation.Nonnull String projectId, @jakarta.annotation.Nonnull String leftGroupName, @jakarta.annotation.Nonnull String rightGroupName, @jakarta.annotation.Nullable AggregationType aggregation, @jakarta.annotation.Nullable QuantMeasure quantification) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/api/projects/{projectId}/compounds/statistics/foldchanges", HttpMethod.DELETE, pathParams, localVarQueryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    ...
    private ResponseSpec getCompoundFoldChangeTableExperimentalRequestCreation(@jakarta.annotation.Nonnull String projectId, @jakarta.annotation.Nullable AggregationType aggregation, @jakarta.annotation.Nullable QuantMeasure quantification) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/api/projects/{projectId}/compounds/statistics/foldchanges/stats-table", HttpMethod.GET, pathParams, localVarQueryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    ...
    private ResponseSpec getFoldChangesByCompoundExperimentalRequestCreation(@jakarta.annotation.Nonnull String projectId, @jakarta.annotation.Nonnull String objectId) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/api/projects/{projectId}/compounds/statistics/foldchanges/{objectId}", HttpMethod.GET, pathParams, localVarQueryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
