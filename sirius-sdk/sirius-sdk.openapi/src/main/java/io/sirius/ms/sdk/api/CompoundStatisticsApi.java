...
public class CompoundStatisticsApi {
     ...
     */
    private ResponseSpec computeCompoundFoldChangesExperimentalRequestCreation(String projectId, FoldChangeJobSubmission foldChangeJobSubmission, List<JobOptField> optFields) throws WebClientResponseException {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Job computeCompoundFoldChangesExperimental(String projectId, FoldChangeJobSubmission foldChangeJobSubmission, List<JobOptField> optFields) throws WebClientResponseException {
        ParameterizedTypeReference<Job> localVarReturnType = new ParameterizedTypeReference<Job>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Job> computeCompoundFoldChangesExperimentalWithHttpInfo(String projectId, FoldChangeJobSubmission foldChangeJobSubmission, List<JobOptField> optFields) throws WebClientResponseException {
        ParameterizedTypeReference<Job> localVarReturnType = new ParameterizedTypeReference<Job>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec computeCompoundFoldChangesExperimentalWithResponseSpec(String projectId, FoldChangeJobSubmission foldChangeJobSubmission, List<JobOptField> optFields) throws WebClientResponseException {
    ...
    private ResponseSpec getFoldChangesByCompoundExperimentalRequestCreation(String projectId, String objectId) throws WebClientResponseException {
        ...
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
            throw new WebClientResponseException("Missing the required parameter 'projectId' when calling getFoldChangesByCompoundExperimental", HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // verify the required parameter 'objectId' is set
        if (objectId == null) {
            throw new WebClientResponseException("Missing the required parameter 'objectId' when calling getFoldChangesByCompoundExperimental", HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/api/projects/{projectId}/compounds/statistics/foldchanges/{objectId}", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
