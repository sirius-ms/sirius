...
public class FeatureStatisticsApi {
     ...
     */
    private ResponseSpec computeAlignedFeatureFoldChangesExperimentalRequestCreation(@jakarta.annotation.Nonnull String projectId, @jakarta.annotation.Nonnull FoldChangeJobSubmission foldChangeJobSubmission, @jakarta.annotation.Nullable List<JobOptField> optFields) throws WebClientResponseException {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Job computeAlignedFeatureFoldChangesExperimental(@jakarta.annotation.Nonnull String projectId, @jakarta.annotation.Nonnull FoldChangeJobSubmission foldChangeJobSubmission, @jakarta.annotation.Nullable List<JobOptField> optFields) throws WebClientResponseException {
        ParameterizedTypeReference<Job> localVarReturnType = new ParameterizedTypeReference<Job>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Job> computeAlignedFeatureFoldChangesExperimentalWithHttpInfo(@jakarta.annotation.Nonnull String projectId, @jakarta.annotation.Nonnull FoldChangeJobSubmission foldChangeJobSubmission, @jakarta.annotation.Nullable List<JobOptField> optFields) throws WebClientResponseException {
        ParameterizedTypeReference<Job> localVarReturnType = new ParameterizedTypeReference<Job>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec computeAlignedFeatureFoldChangesExperimentalWithResponseSpec(@jakarta.annotation.Nonnull String projectId, @jakarta.annotation.Nonnull FoldChangeJobSubmission foldChangeJobSubmission, @jakarta.annotation.Nullable List<JobOptField> optFields) throws WebClientResponseException {
