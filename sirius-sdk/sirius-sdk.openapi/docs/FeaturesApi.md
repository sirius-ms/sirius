...
| [**getFeatureQuantTableRow**](FeaturesApi.md#getFeatureQuantTableRow) | **GET** /api/projects/{projectId}/aligned-features/{alignedFeatureId}/quant-table-row | [INTERNAL] Returns a quantification table that contains the given feature (alignedFeatureId) as its only row |
...
> PagedModelAlignedFeature getAlignedFeaturesByGroupExperimental(projectId, groupName, page, size, sort, msDataSearchPrepared, optFields)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<AlignedFeatureOptField> optFields = Arrays.asList(); // List<AlignedFeatureOptField> | set of optional fields to be included. Use 'none' only to override defaults.
        try {
            PagedModelAlignedFeature result = apiInstance.getAlignedFeaturesByGroupExperimental(projectId, groupName, page, size, sort, msDataSearchPrepared, optFields);
            System.out.println(result);
        } catch (ApiException e) {
...
> PagedModelAlignedFeature getAlignedFeaturesPage(projectId, page, size, sort, searchQuery, msDataSearchPrepared, optFields)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer size = 20; // Integer | The size of the page to be returned
        List<String> sort = Arrays.asList(); // List<String> | Sorting criteria in the format: property,(asc|desc). Default sort order is ascending. Multiple sort criteria are supported.
        String searchQuery = "searchQuery_example"; // String | Optional search query in lucene syntax. Omit this parameter to page over all features.
        Boolean msDataSearchPrepared = false; // Boolean | Returns all fragment spectra in a preprocessed form as used for fast                             Cosine/Modified Cosine computation. Gives you spectra compatible with SpectralLibraryMatch                             peak assignments and reference spectra.
        List<AlignedFeatureOptField> optFields = Arrays.asList(); // List<AlignedFeatureOptField> | set of optional fields to be included. Use 'none' only to override defaults.
        try {
            PagedModelAlignedFeature result = apiInstance.getAlignedFeaturesPage(projectId, page, size, sort, searchQuery, msDataSearchPrepared, optFields);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling FeaturesApi#getAlignedFeaturesPage");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
| **size** | **Integer**| The size of the page to be returned | [optional] [default to 20] |
| **sort** | [**List&lt;String&gt;**](String.md)| Sorting criteria in the format: property,(asc|desc). Default sort order is ascending. Multiple sort criteria are supported. | [optional] |
| **searchQuery** | **String**| Optional search query in lucene syntax. Omit this parameter to page over all features. | [optional] |
| **msDataSearchPrepared** | **Boolean**| Returns all fragment spectra in a preprocessed form as used for fast                             Cosine/Modified Cosine computation. Gives you spectra compatible with SpectralLibraryMatch                             peak assignments and reference spectra. | [optional] [default to false] |
| **optFields** | [**List&lt;AlignedFeatureOptField&gt;**](AlignedFeatureOptField.md)| set of optional fields to be included. Use &#39;none&#39; only to override defaults. | [optional] |
...
> PagedModelStructureCandidateScored getDeNovoStructureCandidatesByFormulaPage(projectId, alignedFeatureId, formulaId, page, size, sort, optFields)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<StructureCandidateOptField> optFields = Arrays.asList(); // List<StructureCandidateOptField> | set of optional fields to be included. Use 'none' only to override defaults.
        try {
            PagedModelStructureCandidateScored result = apiInstance.getDeNovoStructureCandidatesByFormulaPage(projectId, alignedFeatureId, formulaId, page, size, sort, optFields);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling FeaturesApi#getDeNovoStructureCandidatesByFormulaPage");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> PagedModelStructureCandidateFormula getDeNovoStructureCandidatesPage(projectId, alignedFeatureId, page, size, sort, optFields)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<StructureCandidateOptField> optFields = Arrays.asList(); // List<StructureCandidateOptField> | set of optional fields to be included. Use 'none' only to override defaults.
        try {
            PagedModelStructureCandidateFormula result = apiInstance.getDeNovoStructureCandidatesPage(projectId, alignedFeatureId, page, size, sort, optFields);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling FeaturesApi#getDeNovoStructureCandidatesPage");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> List&lt;Feature&gt; getFeatures(projectId, alignedFeatureId)
...
public class Example {
    public static void main(String[] args) {
        ...
        FeaturesApi apiInstance = new FeaturesApi(defaultClient);
        String projectId = "projectId_example"; // String | project-space to read from.
        String alignedFeatureId = "alignedFeatureId_example"; // String | feature (aligned over runs) whose features to read.
        try {
            List<Feature> result = apiInstance.getFeatures(projectId, alignedFeatureId);
            System.out.println(result);
        } catch (ApiException e) {
...
|------------- | ------------- | ------------- | -------------|
| **projectId** | **String**| project-space to read from. | |
| **alignedFeatureId** | **String**| feature (aligned over runs) whose features to read. | |
...
> PagedModelFeature getFeaturesPage(projectId, alignedFeatureId, page, size, sort)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<String> sort = Arrays.asList(); // List<String> | Sorting criteria in the format: property,(asc|desc). Default sort order is ascending. Multiple sort criteria are supported.
        try {
            PagedModelFeature result = apiInstance.getFeaturesPage(projectId, alignedFeatureId, page, size, sort);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling FeaturesApi#getFeaturesPage");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> PagedModelFormulaCandidate getFormulaCandidatesPage(projectId, alignedFeatureId, page, size, sort, msDataSearchPrepared, optFields)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<FormulaCandidateOptField> optFields = Arrays.asList(); // List<FormulaCandidateOptField> | set of optional fields to be included. Use 'none' only to override defaults.
        try {
            PagedModelFormulaCandidate result = apiInstance.getFormulaCandidatesPage(projectId, alignedFeatureId, page, size, sort, msDataSearchPrepared, optFields);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling FeaturesApi#getFormulaCandidatesPage");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> PagedModelSpectralLibraryMatch getSpectralLibraryMatchesPage(projectId, alignedFeatureId, page, size, sort, minSharedPeaks, minSimilarity, inchiKey, optFields)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<SpectralLibraryMatchOptField> optFields = Arrays.asList(); // List<SpectralLibraryMatchOptField> | 
        try {
            PagedModelSpectralLibraryMatch result = apiInstance.getSpectralLibraryMatchesPage(projectId, alignedFeatureId, page, size, sort, minSharedPeaks, minSimilarity, inchiKey, optFields);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling FeaturesApi#getSpectralLibraryMatchesPage");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> PagedModelStructureCandidateScored getStructureCandidatesByFormulaPage(projectId, alignedFeatureId, formulaId, page, size, sort, optFields)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<StructureCandidateOptField> optFields = Arrays.asList(); // List<StructureCandidateOptField> | set of optional fields to be included. Use 'none' only to override defaults.
        try {
            PagedModelStructureCandidateScored result = apiInstance.getStructureCandidatesByFormulaPage(projectId, alignedFeatureId, formulaId, page, size, sort, optFields);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling FeaturesApi#getStructureCandidatesByFormulaPage");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> PagedModelStructureCandidateFormula getStructureCandidatesPage(projectId, alignedFeatureId, page, size, sort, optFields)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<StructureCandidateOptField> optFields = Arrays.asList(); // List<StructureCandidateOptField> | set of optional fields to be included. Use 'none' only to override defaults.
        try {
            PagedModelStructureCandidateFormula result = apiInstance.getStructureCandidatesPage(projectId, alignedFeatureId, page, size, sort, optFields);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling FeaturesApi#getStructureCandidatesPage");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
