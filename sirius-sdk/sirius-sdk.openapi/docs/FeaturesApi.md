...
| [**addGroup1**](FeaturesApi.md#addGroup1) | **PUT** /api/projects/{projectId}/aligned-features/groups/{groupName} | &lt;strong&gt;(EXPERIMENTAL)&lt;/strong&gt; Group tags in the project |
| [**addTags1**](FeaturesApi.md#addTags1) | **PUT** /api/projects/{projectId}/aligned-features/tags/{objectId} | &lt;strong&gt;(EXPERIMENTAL)&lt;/strong&gt; Add tags to an object in the project |
| [**computeFoldChange1**](FeaturesApi.md#computeFoldChange1) | **PUT** /api/projects/{projectId}/aligned-features/foldchange/compute | &lt;strong&gt;(EXPERIMENTAL)&lt;/strong&gt; Compute the fold change between two groups of runs |
...
| [**deleteFoldChange1**](FeaturesApi.md#deleteFoldChange1) | **DELETE** /api/projects/{projectId}/aligned-features/foldchange | &lt;strong&gt;(EXPERIMENTAL)&lt;/strong&gt; Delete fold change |
| [**deleteGroup1**](FeaturesApi.md#deleteGroup1) | **DELETE** /api/projects/{projectId}/aligned-features/groups/{groupName} | &lt;strong&gt;(EXPERIMENTAL)&lt;/strong&gt; Delete tag groups with the given name from the specified project-space |
| [**deleteTags1**](FeaturesApi.md#deleteTags1) | **DELETE** /api/projects/{projectId}/aligned-features/tags/{objectId}/{categoryName} | &lt;strong&gt;(EXPERIMENTAL)&lt;/strong&gt; Delete tag with the given category from the object with the specified ID in the specified project-space |
...
| [**getFoldChange1**](FeaturesApi.md#getFoldChange1) | **GET** /api/projects/{projectId}/aligned-features/foldchange/{objectId} | &lt;strong&gt;(EXPERIMENTAL)&lt;/strong&gt; List all fold changes that are associated with an object |
...
| [**getGroupByName1**](FeaturesApi.md#getGroupByName1) | **GET** /api/projects/{projectId}/aligned-features/groups/{groupName} | &lt;strong&gt;(EXPERIMENTAL)&lt;/strong&gt; Get tag group by name in the given project-space |
| [**getGroups1**](FeaturesApi.md#getGroups1) | **GET** /api/projects/{projectId}/aligned-features/groups | &lt;strong&gt;(EXPERIMENTAL)&lt;/strong&gt; Get all tag category groups in the given project-space |
| [**getGroupsByType1**](FeaturesApi.md#getGroupsByType1) | **GET** /api/projects/{projectId}/aligned-features/groups/type/{groupType} | &lt;strong&gt;(EXPERIMENTAL)&lt;/strong&gt; Get tag groups by type in the given project-space |
...
| [**listFoldChange1**](FeaturesApi.md#listFoldChange1) | **GET** /api/projects/{projectId}/aligned-features/foldchange | &lt;strong&gt;(EXPERIMENTAL)&lt;/strong&gt; List all fold changes in the project space |
| [**objectsByGroup1**](FeaturesApi.md#objectsByGroup1) | **GET** /api/projects/{projectId}/aligned-features/grouped | &lt;strong&gt;(EXPERIMENTAL)&lt;/strong&gt; Get objects by tag group |
| [**objectsByTag1**](FeaturesApi.md#objectsByTag1) | **GET** /api/projects/{projectId}/aligned-features/tagged | &lt;strong&gt;(EXPERIMENTAL)&lt;/strong&gt; Get objects by tag |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling FeaturesApi#addGroup1");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> List&lt;Tag&gt; addTags1(projectId, objectId, tag)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            List<Tag> result = apiInstance.addTags1(projectId, objectId, tag);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling FeaturesApi#addTags1");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling FeaturesApi#computeFoldChange1");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling FeaturesApi#deleteFoldChange1");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling FeaturesApi#deleteGroup1");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> deleteTags1(projectId, objectId, categoryName)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            apiInstance.deleteTags1(projectId, objectId, categoryName);
        } catch (ApiException e) {
            System.err.println("Exception when calling FeaturesApi#deleteTags1");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> List&lt;AlignedFeatureFoldChange&gt; getFoldChange1(projectId, objectId, page, size, sort)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<String> sort = Arrays.asList(); // List<String> | Sorting criteria in the format: property,(asc|desc). Default sort order is ascending. Multiple sort criteria are supported.
        try {
            List<AlignedFeatureFoldChange> result = apiInstance.getFoldChange1(projectId, objectId, page, size, sort);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling FeaturesApi#getFoldChange1");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling FeaturesApi#getGroupByName1");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling FeaturesApi#getGroups1");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling FeaturesApi#getGroupsByType1");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling FeaturesApi#listFoldChange1");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> PageAlignedFeature objectsByGroup1(projectId, group, page, size, sort, optFields)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<AlignedFeatureOptField> optFields = Arrays.asList(); // List<AlignedFeatureOptField> | set of optional fields to be included. Use 'none' only to override defaults.
        try {
            PageAlignedFeature result = apiInstance.objectsByGroup1(projectId, group, page, size, sort, optFields);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling FeaturesApi#objectsByGroup1");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> PageAlignedFeature objectsByTag1(projectId, filter, page, size, sort, optFields)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<AlignedFeatureOptField> optFields = Arrays.asList(); // List<AlignedFeatureOptField> | set of optional fields to be included. Use 'none' only to override defaults.
        try {
            PageAlignedFeature result = apiInstance.objectsByTag1(projectId, filter, page, size, sort, optFields);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling FeaturesApi#objectsByTag1");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
