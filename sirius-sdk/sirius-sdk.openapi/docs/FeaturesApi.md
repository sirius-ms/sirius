...
| [**computeFoldChange1**](FeaturesApi.md#computeFoldChange1) | **PUT** /api/projects/{projectId}/aligned-features/foldchange/compute | Compute the fold change between two groups |
...
| [**deleteFoldChange1**](FeaturesApi.md#deleteFoldChange1) | **DELETE** /api/projects/{projectId}/aligned-features/foldchange | Delete fold change |
...
| [**getFoldChange1**](FeaturesApi.md#getFoldChange1) | **GET** /api/projects/{projectId}/aligned-features/foldchange/{objectId} | List all fold changes that are associated with an object |
...
| [**listFoldChange1**](FeaturesApi.md#listFoldChange1) | **GET** /api/projects/{projectId}/aligned-features/foldchange | List all fold changes in the project space |
