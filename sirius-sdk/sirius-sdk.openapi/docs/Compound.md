...
|------------ | ------------- | ------------- | -------------|
|**compoundId** | **String** | Unique id of this compound entity. |  [optional] |
...
|**neutralMass** | **Double** | Neutral mass of this compound. Ion mass minus the mass of the assigned adduct of each feature of  this compound should result in the same neutral mass |  [optional] |
