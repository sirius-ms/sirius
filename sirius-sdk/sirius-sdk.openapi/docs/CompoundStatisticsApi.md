...
> Job computeCompoundFoldChangesExperimental(projectId, foldChangeJobSubmission, optFields)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            Job result = apiInstance.computeCompoundFoldChangesExperimental(projectId, foldChangeJobSubmission, optFields);
