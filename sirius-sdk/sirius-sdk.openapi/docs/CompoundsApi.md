...
> PagedModelCompound getCompoundsByGroupExperimental(projectId, group, page, size, sort, optFields)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<CompoundOptField> optFields = Arrays.asList(); // List<CompoundOptField> | set of optional fields to be included. Use 'none' only to override defaults.
        try {
            PagedModelCompound result = apiInstance.getCompoundsByGroupExperimental(projectId, group, page, size, sort, optFields);
            System.out.println(result);
        } catch (ApiException e) {
