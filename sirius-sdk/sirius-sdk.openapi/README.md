...
<dependency>
  ...
  <version>3.1+sirius6.3.3-SNAPSHOT</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "io.sirius-ms:sirius-sdk.openapi:3.1+sirius6.3.3-SNAPSHOT"
  }
```
...
- `target/sirius-sdk.openapi-3.1+sirius6.3.3-SNAPSHOT.jar`
- `target/lib/*.jar`
