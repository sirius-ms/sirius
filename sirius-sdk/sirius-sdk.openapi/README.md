...
<dependency>
  ...
  <version>3.1+sirius6.5.4</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "io.sirius-ms:sirius-sdk.openapi:3.1+sirius6.5.4"
  }
```
...
- `target/sirius-sdk.openapi-3.1+sirius6.5.4.jar`
- `target/lib/*.jar`
...
*CompoundsApi* | [**addCompounds**](docs/CompoundsApi.md#addCompounds) | **POST** /api/projects/{projectId}/compounds | Import compounds and their contained features.
...
*CompoundsApi* | [**getCompoundQuantTable**](docs/CompoundsApi.md#getCompoundQuantTable) | **GET** /api/projects/{projectId}/compounds/quant-table | Returns the full quantification table of compounds
*CompoundsApi* | [**getCompoundQuantTableRow**](docs/CompoundsApi.md#getCompoundQuantTableRow) | **GET** /api/projects/{projectId}/compounds/{compoundId}/quant-table-row | [INTERNAL] Returns a quantification table that contains the given compound as its only row
...
*FeaturesApi* | [**addDeNovoStructureCandidate**](docs/FeaturesApi.md#addDeNovoStructureCandidate) | **PUT** /api/projects/{projectId}/aligned-features/{alignedFeatureId}/denovo-structures/add-candidate | [INTERNAL] Add molecular structures (as SMILES) to the list of de novo structures.
...
*FeaturesApi* | [**deleteAlignedFeaturesByQuery**](docs/FeaturesApi.md#deleteAlignedFeaturesByQuery) | **PUT** /api/projects/{projectId}/aligned-features/delete-by-query | Delete all features (aligned over runs) that match the given lucene search query from the specified  project-space.
...
*FeaturesApi* | [**getDeNovoStructureCandidatesByFormula**](docs/FeaturesApi.md#getDeNovoStructureCandidatesByFormula) | **GET** /api/projects/{projectId}/aligned-features/{alignedFeatureId}/formulas/{formulaId}/denovo-structures | [DEPRECATED] List of de novo structure candidates (e
*FeaturesApi* | [**getDeNovoStructureCandidatesByFormulaPage**](docs/FeaturesApi.md#getDeNovoStructureCandidatesByFormulaPage) | **GET** /api/projects/{projectId}/aligned-features/{alignedFeatureId}/formulas/{formulaId}/denovo-structures/page | Page of de novo structure candidates (e.g. generated by MsNovelist) ranked by CSI:FingerID score for the given &#39;formulaId&#39; with minimal information.  StructureCandidates can be enriched with molecular fingerprint.
*FeaturesApi* | [**getDeNovoStructureCandidatesPage**](docs/FeaturesApi.md#getDeNovoStructureCandidatesPage) | **GET** /api/projects/{projectId}/aligned-features/{alignedFeatureId}/denovo-structures/page | Page of de novo structure candidates (e.g. generated by MsNovelist) ranked by CSI:FingerID score for the given &#39;alignedFeatureId&#39; with minimal information.  StructureCandidates can be enriched with molecular fingerprint.
*FeaturesApi* | [**getFeatureQuantTable**](docs/FeaturesApi.md#getFeatureQuantTable) | **GET** /api/projects/{projectId}/aligned-features/quant-table | Returns the full quantification table of features
*FeaturesApi* | [**getFeatureQuantTableRow**](docs/FeaturesApi.md#getFeatureQuantTableRow) | **GET** /api/projects/{projectId}/aligned-features/{alignedFeatureId}/quant-table-row | [INTERNAL] Returns a quantification table that contains the given feature (alignedFeatureId) as its only row
*FeaturesApi* | [**getFeatures**](docs/FeaturesApi.md#getFeatures) | **GET** /api/projects/{projectId}/aligned-features/{alignedFeatureId}/features | [DEPRECATED] Get all features the given feature (aligned over runs) was aligned from
*FeaturesApi* | [**getFeaturesPage**](docs/FeaturesApi.md#getFeaturesPage) | **GET** /api/projects/{projectId}/aligned-features/{alignedFeatureId}/features/page | Page of features the given feature (aligned over runs) was aligned from, one per run it has been detected in
...
*FeaturesApi* | [**getFormulaCandidates**](docs/FeaturesApi.md#getFormulaCandidates) | **GET** /api/projects/{projectId}/aligned-features/{alignedFeatureId}/formulas | [DEPRECATED] List of FormulaResultContainers available for this feature with minimal information
*FeaturesApi* | [**getFormulaCandidatesPage**](docs/FeaturesApi.md#getFormulaCandidatesPage) | **GET** /api/projects/{projectId}/aligned-features/{alignedFeatureId}/formulas/page | Page of FormulaResultContainers available for this feature with minimal information.
...
*FeaturesApi* | [**getSpectralLibraryMatches**](docs/FeaturesApi.md#getSpectralLibraryMatches) | **GET** /api/projects/{projectId}/aligned-features/{alignedFeatureId}/spectral-library-matches | [DEPRECATED] List of spectral library matches for the given &#39;alignedFeatureId&#39;
*FeaturesApi* | [**getSpectralLibraryMatchesPage**](docs/FeaturesApi.md#getSpectralLibraryMatchesPage) | **GET** /api/projects/{projectId}/aligned-features/{alignedFeatureId}/spectral-library-matches/page | Page of spectral library matches for the given &#39;alignedFeatureId&#39;.
...
*FeaturesApi* | [**getStructureCandidates**](docs/FeaturesApi.md#getStructureCandidates) | **GET** /api/projects/{projectId}/aligned-features/{alignedFeatureId}/db-structures | [DEPRECATED] List of structure database search candidates ranked by CSI:FingerID score for the given &#39;alignedFeatureId&#39; with minimal information
*FeaturesApi* | [**getStructureCandidatesByFormula**](docs/FeaturesApi.md#getStructureCandidatesByFormula) | **GET** /api/projects/{projectId}/aligned-features/{alignedFeatureId}/formulas/{formulaId}/db-structures | [DEPRECATED] List of CSI:FingerID structure database search candidates for the given &#39;formulaId&#39; with minimal information
*FeaturesApi* | [**getStructureCandidatesByFormulaPage**](docs/FeaturesApi.md#getStructureCandidatesByFormulaPage) | **GET** /api/projects/{projectId}/aligned-features/{alignedFeatureId}/formulas/{formulaId}/db-structures/page | Page of CSI:FingerID structure database search candidates for the given &#39;formulaId&#39; with minimal information.
*FeaturesApi* | [**getStructureCandidatesPage**](docs/FeaturesApi.md#getStructureCandidatesPage) | **GET** /api/projects/{projectId}/aligned-features/{alignedFeatureId}/db-structures/page | Page of structure database search candidates ranked by CSI:FingerID score for the given &#39;alignedFeatureId&#39; with minimal information.
...
*SearchableDatabasesApi* | [**createDatabase**](docs/SearchableDatabasesApi.md#createDatabase) | **POST** /api/databases/{databaseId} | Create a new, empty custom database
*SearchableDatabasesApi* | [**getCustomDatabases**](docs/SearchableDatabasesApi.md#getCustomDatabases) | **GET** /api/databases/custom | List only the custom databases, that is the structure databases and spectral libraries the user has  created or added.
*SearchableDatabasesApi* | [**getDatabase**](docs/SearchableDatabasesApi.md#getDatabase) | **GET** /api/databases/{databaseId} | Get a single searchable database by its id.
*SearchableDatabasesApi* | [**getDatabases**](docs/SearchableDatabasesApi.md#getDatabases) | **GET** /api/databases | List all searchable databases, both the ones included in SIRIUS and the custom ones added by the user
...
*SearchableDatabasesApi* | [**getIncludedDatabases**](docs/SearchableDatabasesApi.md#getIncludedDatabases) | **GET** /api/databases/included | List only the databases that ship with SIRIUS, such as PubChem and the bio databases.
*SearchableDatabasesApi* | [**getStructures**](docs/SearchableDatabasesApi.md#getStructures) | **GET** /api/databases/{databaseId}/structures | [EXPERIMENTAL] Page through the structures contained in a custom database
...
*SearchableDatabasesApi* | [**removeDatabase**](docs/SearchableDatabasesApi.md#removeDatabase) | **DELETE** /api/databases/{databaseId} | Remove a custom database from this SIRIUS instance, and optionally delete it from disk
*SearchableDatabasesApi* | [**updateDatabase**](docs/SearchableDatabasesApi.md#updateDatabase) | **PUT** /api/databases/{databaseId} | Change the settings of an existing custom database
...
## Documentation for Models
 ...
 - [PagedModelFeature](docs/PagedModelFeature.md)
