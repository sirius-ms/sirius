...
<dependency>
  ...
  <version>3.1.0+sirius6.2.4-SNAPSHOT</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "io.sirius-ms:sirius-sdk.openapi:3.1.0+sirius6.2.4-SNAPSHOT"
  }
```
...
- `target/sirius-sdk.openapi-3.1.0+sirius6.2.4-SNAPSHOT.jar`
- `target/lib/*.jar`
