...
Please follow the instructions to add the sirius-sdk to your project [here](https://github.com/sirius-ms/sirius/blob/stable/sirius-sdk/README.md#availability).

## Getting Started with individual APIs
Below you find some example code about the usage of one of the specific api endpoind groups.
However, for most usse cases the [SiriusSDK.java wrapper class](https://github.com/sirius-ms/sirius/blob/stable/sirius-sdk/README.md#usage) should be the more convienient entrypoint.
...
public class ActuatorApiExample {
    ...
    public static void main(String[] args) {
        try (SiriusSDK sirius = SiriusSDK.startAndConnectLocally(SiriusSDK.ShutdownMode.AUTO, false)) {
          ActuatorApi apiInstance = new ActuatorApi(sirius.getApiClient());
          try {
