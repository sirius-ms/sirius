...
public class FTDataset {
    ...
    public FTDataset(List<FTDataElement> elements, Scoring<Fragment> scoring, int numberOfJoins,
                     boolean many2manyJoins) {
        this(elements, elements, true, new Factory<Fragment>(FTree.treeAdapter(),
                scoring, numberOfJoins, many2manyJoins));
    }

    public FTDataset(List<FTDataElement> left, List<FTDataElement> right, Scoring<Fragment> scoring,
                     int numberOfJoins, boolean many2manyJoins) {
        this(left, right, false, new Factory<Fragment>(FTree.treeAdapter(),
                scoring, numberOfJoins, many2manyJoins));
    }
