...
public class OptionSet {
    ...
    OptionSet(Options.Prefix prefix,
              Options.Multiplicity defaultMultiplicity, String setName,
    ...
    public OptionSet addOption(String key, Options.Separator separator) {
        return addOption(key, false, separator, true,
                defaultMultiplicity);
    }
    ...
    public OptionSet addOption(String key, boolean details,
        ...
        return addOption(key, details, separator, true,
                defaultMultiplicity);
    }
    ...
    OptionSet addOption(String key, boolean details,
        ...
        if (keys.containsKey(key))
            throw new IllegalArgumentException(CLASS + ": the key "
                    + key
                    + " has already been defined for this OptionSet");

        OptionData od = new OptionData(prefix, key, details, separator,
                value, multiplicity);
        options.add(od);
        keys.put(key, od);
