...
/*
* 12/12/07 - Richard Hill
* This class is from the Java World website and was originally written by Dr. Matthias Laux on 08/16/04.
* More information can be found at: http://www.javaworld.com/javaworld/jw-08-2004/jw-0816-command.html
* The code has been modified very slightly for use in the Novice C Compiler (ncc) project.
*/
...
public class Options {
    ...
    public Options(String args[], Prefix prefix,
                   Multiplicity defaultMultiplicity, int defMinData,
                   int defMaxData) {
    ...
    public Options(String args[], Multiplicity defaultMultiplicity,
        ...
        this (args, Prefix.DASH, defaultMultiplicity, defMinData,
                defMaxData);
    }
    ...
    public Options(String args[], int defMinData, int defMaxData) {
        this (args, Prefix.DASH, Multiplicity.ONCE, defMinData,
                defMaxData);
    }
    ...
    public Options(String args[], Prefix prefix, int defMinData,
                   int defMaxData) {
    ...
    public OptionSet addSet(String setName, int minData, int maxData) {
        ...
        if (optionSets.containsKey(setName))
            throw new IllegalArgumentException(CLASS
                    + ": a set with the name " + setName
                    + " has already been defined");
        OptionSet os = new OptionSet(prefix, defaultMultiplicity,
                setName, minData, maxData);
    ...
    public boolean check(String setName, boolean ignoreUnmatched,
        ...
        if (data.size() < set.getMinData()
                || data.size() > set.getMaxData()) {
    ...
    public void addOptionAllSets(String key, Multiplicity multiplicity) {
        for (String setName : optionSets.keySet())
            optionSets.get(setName).addOption(key, false,
                    Separator.NONE, false, multiplicity);
    }
    ...
    public void addOptionAllSets(String key, Separator separator) {
        for (String setName : optionSets.keySet())
            optionSets.get(setName).addOption(key, false, separator,
                    true, defaultMultiplicity);
    }
    ...
    public void addOptionAllSets(String key, boolean details,
                                 Separator separator) {
        for (String setName : optionSets.keySet())
            optionSets.get(setName).addOption(key, details, separator,
                    true, defaultMultiplicity);
    }
