...
public class StructureCandidate {
    ...
    /**
     * List of links to reference spectra links for this structure candidate
     * and there similarity with the best matching input spectrum
     * OPTIONAL: needs to be added by parameter
     */
    List<SpectraCandidate> referenceSpectra;
