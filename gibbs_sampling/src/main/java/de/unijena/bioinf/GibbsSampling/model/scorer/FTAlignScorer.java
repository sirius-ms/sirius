...
public class FTAlignScorer implements EdgeScorer {
    ...
    private TObjectDoubleHashMap<MFCandidate> norm;
    ...
    public void prepare(MFCandidate[][] candidates) {
        ...
        if(this.normalize) {
            ...
            MFCandidate[][] var2 = candidates;
            int var3 = candidates.length;

            for(int var4 = 0; var4 < var3; ++var4) {
                MFCandidate[] candidateArray = var2[var4];
                MFCandidate[] var6 = candidateArray;
                int var7 = candidateArray.length;

                for(int var8 = 0; var8 < var7; ++var8) {
                    MFCandidate candidate = var6[var8];
