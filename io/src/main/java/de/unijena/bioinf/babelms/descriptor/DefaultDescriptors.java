...
class DefaultDescriptors {
    ...
    private static class PeakDescriptor implements Descriptor<Peak> {
        ...
        @Override
        public String[] getKeywords() {
            return new String[]{"mz", "relativeIntensity"};
        }
        ...
        public <G, D, L> Peak read(DataDocument<G, D, L> document, D dictionary) {
            return new Peak(document.getDoubleFromDictionary(dictionary, "mz"), document.getDoubleFromDictionary(dictionary, "relativeIntensity"));
        }
