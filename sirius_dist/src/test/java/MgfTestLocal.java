...
public class MgfTestLocal {
    ...
    public void testTopCandidates() throws IOException {
        TestMethods.isDirExisting(absPath + "sirius_cli/src/test/temp_results/mgf_temp_output/0_laudanosine_FEATURE_1/canopus".replace("/", sep));
        TestMethods.isDirExisting(absPath + "sirius_cli/src/test/temp_results/mgf_temp_output/0_laudanosine_FEATURE_1/canopus_npc".replace("/", sep));
