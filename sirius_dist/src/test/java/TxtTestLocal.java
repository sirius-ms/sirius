...
public class TxtTestLocal {
    ...
    public void testTopCandidates(){
        ...
        String[] post_formula = TestMethods.readCandidates(absPath + "sirius_cli/src/test/temp_results/txt_temp_summary/0_unknown_/formula_candidates.tsv".replace("/", sep), rank_count, table_feature);
