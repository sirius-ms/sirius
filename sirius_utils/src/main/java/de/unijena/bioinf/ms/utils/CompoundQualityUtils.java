...
public class CompoundQualityUtils {
    ...
    protected double estimateMedianNoise(List<Ms2Experiment> experiments) throws IOException {
        ...
        DatasetStatistics statistics = preprocessor.makeStatistics(dataset);
        return statistics.getMedianMs2NoiseIntensity();
    }
