...
public interface IdentifyOptions extends TreeOptions {
    ...
    @Option(shortName = "i", defaultValue = "score", description = "how handle isotope pattern data. Use 'score' to use them for ranking or 'filter' if you just want to remove candidates with bad isotope pattern")
