...
public interface OutputOptions {
    ...
    @Option(shortName = "O", defaultToNull = true, description = "target of the output. For single output, this is a file name, for multiple outputs this is a directory path")
