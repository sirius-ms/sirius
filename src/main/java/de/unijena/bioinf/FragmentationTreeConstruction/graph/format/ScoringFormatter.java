...
public class ScoringFormatter implements VertexFormatter<TreeFragment> {
    ...
    protected final List<MS2ClosureScorer> ms2Scores;
    protected final List<EdgeScorer> edgeScorers;
    ...
    public ScoringFormatter(DecompositionScorer rootScorer, DecompositionScorer fragmentScorer, EdgeScorer edgeScorer) {
        this(rootScorer, fragmentScorer, edgeScorer, null, null);
    }

    public ScoringFormatter(DecompositionScorer rootScorer, DecompositionScorer fragmentScorer, EdgeScorer edgeScorer, MS2ClosureScorer ms2Scorer, FragmentationTree tree) {
        ...
        ms2Scores = (ms2Scorer instanceof MS2ClosureScoreList) ? ((MS2ClosureScoreList)ms2Scorer).getScorers()
