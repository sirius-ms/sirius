 ...
 * @author Kai Dührkop
 */
@ScoreName("common loss")
public class CommonLossEdgeScorer implements EdgeScorer {

    private final HashMap<MolecularFormula, Double> map;

    private final static String[] unplausibleLosses = new String[]{"C2O", "C4O", "C3H2", "C5H2", "C7H2", "N", "C"};
    ...
    public static CommonLossEdgeScorer getDefaultUnplausibleLossScorer(double score) {
        final HashMap<MolecularFormula, Double> map = new HashMap<MolecularFormula, Double>();
        for (String loss : unplausibleLosses) {
