...
public class Pipeline {
    ...
    private MS2ClosureScorer MS2ClosureScorer;
    ...
    public void setToTrained() {
        ...
        final ArrayList<MS2ClosureScorer> ms2ClosureScorers = new ArrayList<MS2ClosureScorer>();
        ...
        // FINISH
        setMS2ClosureScorer(new MS2ClosureScoreList(ms2ClosureScorers));
    ...
    public FragmentationGraph buildGraph(ProcessedInput input, ScoredMolecularFormula pmd) {
        ...
        final Future<?> task = parallelizer.runInBackground(new Runnable() {
            @Override
            public void run() {
                MS2ClosureScorer.score(graphPeaks, graph.getProcessedInput(), ms2Scores);
            }
        });
    ...
    public EdgeScorer getEdgeScorer() {
        return edgeScorer;
    }

    public void setEdgeScorer(EdgeScorer edgeScorer) {
    ...
    public MS2ClosureScorer getMS2ClosureScorer() {
        return MS2ClosureScorer;
    }

    public void setMS2ClosureScorer(MS2ClosureScorer MS2ClosureScorer) {
        this.MS2ClosureScorer = MS2ClosureScorer;
    }
}
