...
public class ParameterFormatter implements Formatter<Object> {
    ...
    private Parameter mergeParameters(final Parameter fieldDefinition, final Parameter klassDefinition) {
        ...
        return new Parameter(){
            ...
            @Override
            public Class<? extends Formatter<Object>> formatter() {
                return fieldDefinition.formatter() == Parameter.Default.class ? klassDefinition.formatter() : fieldDefinition.formatter();
            }
