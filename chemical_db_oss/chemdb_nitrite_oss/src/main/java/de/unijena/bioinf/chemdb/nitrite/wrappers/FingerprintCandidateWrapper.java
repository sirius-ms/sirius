...
public class FingerprintCandidateWrapper implements NitriteWriteString {

    public long id;

    public MolecularFormula formula;

    public FingerprintCandidate candidate;

    public FingerprintCandidateWrapper() {  }

    public FingerprintCandidateWrapper(MolecularFormula formula, FingerprintCandidate candidate) {
    ...
    public static class WrapperSerializer extends JsonSerializer<FingerprintCandidateWrapper> {

        private final JsonSerializer<FingerprintCandidate> serializer = new FingerprintCandidate.Serializer();

        @Override
        public void serialize(FingerprintCandidateWrapper value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
    ...
    public static class WrapperDeserializer extends JsonDeserializer<FingerprintCandidateWrapper> {

        private final JsonDeserializer<FingerprintCandidate> deserializer;
        ...
        public FingerprintCandidateWrapper deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
            ...
            FingerprintCandidate candidate = null;
            ...
            if (candidate != null && formula != null) {
                return new FingerprintCandidateWrapper(formula, candidate);
            }
            throw new IOException("not a valid fingerprint candidate.");
        }
    }
