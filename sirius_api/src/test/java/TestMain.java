...
public class TestMain {
    ...
    public static void main(String[] args) {
        ...
        s.getMs2Analyzer().setTreeBuilder(new AbstractTreeBuilder<>(GrbSolver.Factory));
        s.getMs2Analyzer().registerPlugin(new TreeStatisticPlugin());
        ...
        System.out.println("-----------------------------");
        System.out.println(new FTJsonWriter().treeToJsonString(read));
