...
[![Generic badge](https://img.shields.io/badge/Version-5.8.0-informational.svg)](https://shields.io/)
...
### SIRIUS+CSI:FingerID GUI and CLI - Version 5.8.0 (2023-07-04)
...
- for Windows (64bit): [msi](https://github.com/boecker-lab/sirius/releases/download/v5.8.0/sirius-5.8.0-win64.msi) / [zip](https://github.com/boecker-lab/sirius/releases/download/v5.8.0/sirius-5.8.0-win64.zip) / [msi (signed by Bright Giant)](https://github.com/bright-giant/sirius/releases/download/v5.8.0/sirius-5.8.0-win64.msi)
- for Mac (64bit): [pkg](https://github.com/boecker-lab/sirius/releases/download/v5.8.0/sirius-5.8.0-osx64.pkg) / [zip](https://github.com/boecker-lab/sirius/releases/download/v5.8.0/sirius-5.8.0-osx64.zip) / [pkg (signed by Bright Giant)](https://github.com/bright-giant/sirius/releases/download/v5.8.0/sirius-5.8.0-osx64.pkg)
- for Linux (64bit): [zip](https://github.com/boecker-lab/sirius/releases/download/v5.8.0/sirius-5.8.0-linux64.zip)

### SIRIUS+CSI:FingerID Command-Line Interface only - Version 5.8.0 (2023-07-04)
##### These versions include the Java Runtime Environment, so there is no need to install Java separately! Just download, install/unpack and execute.
- for Windows (64bit): [msi](https://github.com/boecker-lab/sirius/releases/download/v5.8.0/sirius-5.8.0-win64-headless.msi) / [zip](https://github.com/boecker-lab/sirius/releases/download/v5.8.0/sirius-5.8.0-win64-headless.zip) / [msi (signed by Bright Giant)](https://github.com/bright-giant/sirius/releases/download/v5.8.0/sirius-5.8.0-win64-headless.msi)
- for Mac (64bit): [pkg](https://github.com/boecker-lab/sirius/releases/download/v5.8.0/sirius-5.8.0-osx64-headless.pkg) / [zip](https://github.com/boecker-lab/sirius/releases/download/v5.8.0/sirius-5.8.0-osx64-headless.zip) / [pkg (signed by Bright Giant)](https://github.com/bright-giant/sirius/releases/download/v5.8.0/sirius-5.8.0-osx64-headless.pkg)
- for Linux (64bit): [zip](https://github.com/boecker-lab/sirius/releases/download/v5.8.0/sirius-5.8.0-linux64-headless.zip)
