...
[![Generic badge](https://img.shields.io/badge/Version-5.5.2-informational.svg)](https://shields.io/)
...
### SIRIUS+CSI:FingerID GUI and CLI - Version 5.5.2 (2022-05-21)
...
- for Windows (64bit): [msi](https://github.com/boecker-lab/sirius/releases/download/v5.5.2/sirius-5.5.2-win64.msi) / [zip](https://github.com/boecker-lab/sirius/releases/download/v5.5.2/sirius-5.5.2-win64.zip)
- for Linux (64bit): [zip](https://github.com/boecker-lab/sirius/releases/download/v5.5.2/sirius-5.5.2-linux64.zip)
- for Mac (64bit): [pkg](https://github.com/boecker-lab/sirius/releases/download/v5.5.2/sirius-5.5.2-osx64.pkg) / [zip](https://github.com/boecker-lab/sirius/releases/download/v5.5.2/sirius-5.5.2-osx64.zip)

### SIRIUS+CSI:FingerID Command-Line Interface only - Version 5.5.2 (2022-05-21)
##### These versions include the Java Runtime Environment, so there is no need to install Java separately! Just download, install/unpack and execute.
- for Windows (64bit): [msi](https://github.com/boecker-lab/sirius/releases/download/v5.5.2/sirius-5.5.2-win64-headless.msi) / [zip](https://github.com/boecker-lab/sirius/releases/download/v5.5.2/sirius-5.5.2-win64-headless.zip)
- for Linux (64bit): [zip](https://github.com/boecker-lab/sirius/releases/download/v5.5.2/sirius-5.5.2-linux64-headless.zip)
- for Mac (64bit): [pkg](https://github.com/boecker-lab/sirius/releases/download/v5.5.2/sirius-5.5.2-osx64-headless.pkg) / [zip](https://github.com/boecker-lab/sirius/releases/download/v5.5.2/sirius-5.5.2-osx64-headless.zip)
