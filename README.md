...
[![Generic badge](https://img.shields.io/badge/Version-4.7.4--SNAPSHOT-informational.svg)](https://shields.io/)
...
### SIRIUS+CSI:FingerID GUI and CLI - Version 4.7.4-SNAPSHOT (2021-04-12)
...
- for Windows (64bit): [msi](https://bio.informatik.uni-jena.de/repository/dist-snapshot-local/de/unijena/bioinf/ms/sirius/4.7.4-SNAPSHOT/sirius-4.7.4-SNAPSHOT-win64.msi) / [zip](https://bio.informatik.uni-jena.de/repository/dist-snapshot-local/de/unijena/bioinf/ms/sirius/4.7.4-SNAPSHOT/sirius-4.7.4-SNAPSHOT-win64.zip)
- for Linux (64bit): [zip](https://bio.informatik.uni-jena.de/repository/dist-snapshot-local/de/unijena/bioinf/ms/sirius/4.7.4-SNAPSHOT/sirius-4.7.4-SNAPSHOT-linux64.zip)
- for Mac (64bit): [pkg](https://bio.informatik.uni-jena.de/repository/dist-snapshot-local/de/unijena/bioinf/ms/sirius/4.7.4-SNAPSHOT/sirius-4.7.4-SNAPSHOT-osx64.pkg) / [zip](https://bio.informatik.uni-jena.de/repository/dist-snapshot-local/de/unijena/bioinf/ms/sirius/4.7.4-SNAPSHOT/sirius-4.7.4-SNAPSHOT-osx64.zip)

### SIRIUS+CSI:FingerID Command-Line Interface only - Version 4.7.4-SNAPSHOT (2021-04-12)
##### These versions include the Java Runtime Environment, so there is no need to install Java separately! Just download, install/unpack and execute.
- for Windows (64bit): [msi](https://bio.informatik.uni-jena.de/repository/dist-snapshot-local/de/unijena/bioinf/ms/sirius/4.7.4-SNAPSHOT/sirius-4.7.4-SNAPSHOT-win64-headless.msi) / [zip](https://bio.informatik.uni-jena.de/repository/dist-snapshot-local/de/unijena/bioinf/ms/sirius/4.7.4-SNAPSHOT/sirius-4.7.4-SNAPSHOT-win64-headless.zip)
- for Linux (64bit): [zip](https://bio.informatik.uni-jena.de/repository/dist-snapshot-local/de/unijena/bioinf/ms/sirius/4.7.4-SNAPSHOT/sirius-4.7.4-SNAPSHOT-linux64-headless.zip)
- for Mac (64bit): [pkg](https://bio.informatik.uni-jena.de/repository/dist-snapshot-local/de/unijena/bioinf/ms/sirius/4.7.4-SNAPSHOT/sirius-4.7.4-SNAPSHOT-osx64-headless.pkg) / [zip](https://bio.informatik.uni-jena.de/repository/dist-snapshot-local/de/unijena/bioinf/ms/sirius/4.7.4-SNAPSHOT/sirius-4.7.4-SNAPSHOT-osx64-headless.zip)
