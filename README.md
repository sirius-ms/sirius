...
[![Generic badge](https://img.shields.io/badge/Version-4.7.0-informational.svg)](https://shields.io/)
...
### SIRIUS+CSI:FingerID GUI and CLI - Version 4.7.0 (2021-03-24)
...
- for Windows (64bit): [msi](https://bio.informatik.uni-jena.de/repository/dist-release-local/de/unijena/bioinf/ms/sirius/4.7.0/sirius-4.7.0-win64.msi) / [zip](https://bio.informatik.uni-jena.de/repository/dist-release-local/de/unijena/bioinf/ms/sirius/4.7.0/sirius-4.7.0-win64.zip)
- for Linux (64bit): [zip](https://bio.informatik.uni-jena.de/repository/dist-release-local/de/unijena/bioinf/ms/sirius/4.7.0/sirius-4.7.0-linux64.zip)
- for Mac (64bit): [pkg](https://bio.informatik.uni-jena.de/repository/dist-release-local/de/unijena/bioinf/ms/sirius/4.7.0/sirius-4.7.0-osx64.pkg) / [zip](https://bio.informatik.uni-jena.de/repository/dist-release-local/de/unijena/bioinf/ms/sirius/4.7.0/sirius-4.7.0-osx64.zip)

### SIRIUS+CSI:FingerID Command-Line Interface only - Version 4.7.0 (2021-03-24)
##### These versions include the Java Runtime Environment, so there is no need to install Java separately! Just download, install/unpack and execute.
- for Windows (64bit): [msi](https://bio.informatik.uni-jena.de/repository/dist-release-local/de/unijena/bioinf/ms/sirius/4.7.0/sirius-4.7.0-win64-headless.msi) / [zip](https://bio.informatik.uni-jena.de/repository/dist-release-local/de/unijena/bioinf/ms/sirius/4.7.0/sirius-4.7.0-win64-headless.zip)
- for Linux (64bit): [zip](https://bio.informatik.uni-jena.de/repository/dist-release-local/de/unijena/bioinf/ms/sirius/4.7.0/sirius-4.7.0-linux64-headless.zip)
- for Mac (64bit): [pkg](https://bio.informatik.uni-jena.de/repository/dist-release-local/de/unijena/bioinf/ms/sirius/4.7.0/sirius-4.7.0-osx64-headless.pkg) / [zip](https://bio.informatik.uni-jena.de/repository/dist-release-local/de/unijena/bioinf/ms/sirius/4.7.0/sirius-4.7.0-osx64-headless.zip)
