...
[![Generic badge](https://img.shields.io/badge/Version-4.9.5-informational.svg)](https://shields.io/)
...
### SIRIUS+CSI:FingerID GUI and CLI - Version 4.9.5 (2021-09-29)
...
- for Windows (64bit): [msi](https://github.com/boecker-lab/sirius/releases/download/v4.9.5/sirius-4.9.5-win64.msi) / [zip](https://github.com/boecker-lab/sirius/releases/download/v4.9.5/sirius-4.9.5-win64.zip)
- for Linux (64bit): [zip](https://github.com/boecker-lab/sirius/releases/download/v4.9.5/sirius-4.9.5-linux64.zip)
- for Mac (64bit): [pkg](https://github.com/boecker-lab/sirius/releases/download/v4.9.5/sirius-4.9.5-osx64.pkg) / [zip](https://github.com/boecker-lab/sirius/releases/download/v4.9.5/sirius-4.9.5-osx64.zip)

### SIRIUS+CSI:FingerID Command-Line Interface only - Version 4.9.5 (2021-09-29)
##### These versions include the Java Runtime Environment, so there is no need to install Java separately! Just download, install/unpack and execute.
- for Windows (64bit): [msi](https://github.com/boecker-lab/sirius/releases/download/v4.9.5/sirius-4.9.5-win64-headless.msi) / [zip](https://github.com/boecker-lab/sirius/releases/download/v4.9.5/sirius-4.9.5-win64-headless.zip)
- for Linux (64bit): [zip](https://github.com/boecker-lab/sirius/releases/download/v4.9.5/sirius-4.9.5-linux64-headless.zip)
- for Mac (64bit): [pkg](https://github.com/boecker-lab/sirius/releases/download/v4.9.5/sirius-4.9.5-osx64-headless.pkg) / [zip](https://github.com/boecker-lab/sirius/releases/download/v4.9.5/sirius-4.9.5-osx64-headless.zip)
