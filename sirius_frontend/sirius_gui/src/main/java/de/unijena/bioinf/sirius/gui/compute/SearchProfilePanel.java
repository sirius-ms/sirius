...
public class SearchProfilePanel extends JPanel {
    ...
    private SearchProfilePanel(final Window owner, PrecursorIonType ionType, boolean selectIonization, boolean enableFallback){
        ...
        if (selectIonization){
            ...
            mainwindow.add(new JLabel("adduct type"));
            mainwindow.add(ionizationCB);
        }
        ...
        mainwindow.add(new JLabel("  instrument"));
        mainwindow.add(instrumentCB);
        ...
        mainwindow.add(new JLabel("  ppm"));
        mainwindow.add(ppmSpinner);
        ...
        mainwindow.add(new JLabel(" candidates"));
        mainwindow.add(candidatesSpinner);
        ...
        if (!selectIonization) {
            mainwindow = new JPanel(new FlowLayout(FlowLayout.LEFT, 5, 5));
            ionizations = new Vector<>();
            ...
            mainwindow.add(new JLabel("  fallback for unknown adduct types"));
            mainwindow.add(ionizationCB);
            this.add(mainwindow);
        }
        ...
        //////////
        {
            ...
            mainwindow.add(formulaCombobox);
        }
    }
