...
//    UIManager.put("ProgressBar.background", ICON_RED);
//    UIManager.put("ProgressBar.foreground", ICON_GREEN);
//    UIManager.put("ProgressBar.selectionBackground", ICON_YELLOW);
//    UIManager.put("ProgressBar.selectionForeground", ICON_BLUE);
