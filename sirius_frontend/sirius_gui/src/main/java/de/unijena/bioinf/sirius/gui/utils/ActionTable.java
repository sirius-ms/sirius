...
import de.unijena.bioinf.sirius.gui.mainframe.results.results_table.SiriusResultTableFormat;
...
public class ActionTable<T extends AbstractBean> extends JTable {
    ...
    public ActionTable(List<T> elements, TableFormat<T> format, Class<T> elementType) {
        this(elements, format, new AbstractMatcherEditor<T>() {}, elementType);
    }
    ...
    public static void main(String[] args) {
        ...
        ActionTable<SiriusResultElement> issuesJTable = new ActionTable<>(new SiriusResultTableFormat(), SiriusResultElement.class);
