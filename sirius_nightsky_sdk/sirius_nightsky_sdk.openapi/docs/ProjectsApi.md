...
| [**importMsRunDataLocally**](ProjectsApi.md#importMsRunDataLocally) | **POST** /api/projects/{projectId}/import/ms-local-data-files | Import and Align full MS-Runs from various formats into the specified project  Possible formats (mzML, mzXML)   ATTENTION: This is loading input files from the filesystem where the SIRIUS service is running,  not on the system where the client SDK is running. |
...
> Job importMsRunDataAsJobLocally(projectId, requestBody, alignRuns, allowMs1Only, optFields)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<JobOptField> optFields = Arrays.asList(); // List<JobOptField> | set of optional fields to be included. Use 'none' only to override defaults.
        try {
            Job result = apiInstance.importMsRunDataAsJobLocally(projectId, requestBody, alignRuns, allowMs1Only, optFields);
            System.out.println(result);
        } catch (ApiException e) {
...
> ImportResult importMsRunDataLocally(projectId, requestBody, alignRuns, allowMs1Only)
...
public class Example {
    public static void main(String[] args) {
        ...
        Boolean allowMs1Only = true; // Boolean | 
        try {
            ImportResult result = apiInstance.importMsRunDataLocally(projectId, requestBody, alignRuns, allowMs1Only);
            System.out.println(result);
        } catch (ApiException e) {
