...
public class FeaturesApiTest {
     ...
     */
    @Test
    public void getDeNovoStructureCandidatesTest()  {
        String projectId = null;
        String alignedFeatureId = null;
        List<StructureCandidateOptField> optFields = null;
        List<StructureCandidateFormula> response = api.getDeNovoStructureCandidates(projectId, alignedFeatureId, optFields);
     ...
     */
    @Test
    public void getDeNovoStructureCandidatesByFormulaTest()  {
        String projectId = null;
        String alignedFeatureId = null;
        String formulaId = null;
        List<StructureCandidateOptField> optFields = null;
        List<StructureCandidateScored> response = api.getDeNovoStructureCandidatesByFormula(projectId, alignedFeatureId, formulaId, optFields);
     ...
     */
    @Test
    public void getDeNovoStructureCandidatesByFormulaPagedTest()  {
        String projectId = null;
        String alignedFeatureId = null;
        String formulaId = null;
        Integer page = null;
        ...
        List<String> sort = null;
        List<StructureCandidateOptField> optFields = null;
        PageStructureCandidateScored response = api.getDeNovoStructureCandidatesByFormulaPaged(projectId, alignedFeatureId, formulaId, page, size, sort, optFields);
     ...
     */
    @Test
    public void getDeNovoStructureCandidatesPagedTest()  {
        String projectId = null;
        String alignedFeatureId = null;
        Integer page = null;
        Integer size = null;
        List<String> sort = null;
        List<StructureCandidateOptField> optFields = null;
        PageStructureCandidateFormula response = api.getDeNovoStructureCandidatesPaged(projectId, alignedFeatureId, page, size, sort, optFields);
