...
import de.unijena.bioinf.FragmentationTreeConstruction.computation.scoring.legacy.EdgeScoreList;
import de.unijena.bioinf.FragmentationTreeConstruction.computation.scoring.FreeRadicalEdgeScorer;
import de.unijena.bioinf.FragmentationTreeConstruction.computation.scoring.legacy.LossSizeEdgeScorer;
...
public class MainAnalysis {
    ...
    public void run() throws FileNotFoundException {
        ...
        pipeline.setPeakPairScorer(new LossSizeEdgeScorer(distribution));
