...
class TitledIconBorder extends AbstractBorder
{
    /**
     ...
     */
    public TitledIconBorder(String title) {
     ...
     * @param title  the title the border should display
     */
    public TitledIconBorder(Border border, String title) {
    ...
    private void installPropertyChangeListeners() {
        final WeakReference<TitledIconBorder> weakReference = new WeakReference<TitledIconBorder>(this);
