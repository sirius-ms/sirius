...
public class CandidateListStructureView extends JPanel {
    ...
    public CandidateListStructureView(final DefaultEventSelectionModel<FingerprintCandidateBean> selections) {
        ...
        final ObservableElementList<FingerprintCandidateBean> list = new ObservableElementList<>(new BasicEventList<>(), GlazedLists.beanConnector(FingerprintCandidateBean.class));
        ...
        selections.addListSelectionListener(e -> {
            list.clear();
