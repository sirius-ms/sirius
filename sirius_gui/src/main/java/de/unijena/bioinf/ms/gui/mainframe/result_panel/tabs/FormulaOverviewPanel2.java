 ...
 */
public class FormulaOverviewPanel2 extends JPanel implements PanelDescription, Loadable {
    @Override
    ...
    private final SpectraTreeVisualizationPanel spectrumTreeView;
    private final FormulaListDetailView formulaListDetailView;

    public FormulaOverviewPanel2(FormulaList siriusResultElements, SiriusGui siriusGui) {
        super(new BorderLayout());

        formulaListDetailView = new FormulaListDetailView(siriusResultElements);
        spectrumTreeView = new SpectraTreeVisualizationPanel(siriusResultElements, siriusGui);
