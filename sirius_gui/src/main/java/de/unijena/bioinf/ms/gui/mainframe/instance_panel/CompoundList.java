...
public class CompoundList {
    ...
    public CompoundList(@NotNull SiriusGui gui) {
        ...
        searchField.setToolTipText("Type text to perform a full text search on the data below. Hit enter to start searching. Use 'name: x' to filter by InChIKey (2D) or structure name (via PubChem) and 'class: x' to filter by compound class.");
