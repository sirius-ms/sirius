...
public class GuiProjectSpace {
    ...
    public static SiriusProjectSpace createGuiProjectSpace(File location) throws IOException {
        ...
        String formatterString = SiriusProperties.SIRIUS_PROPERTIES_FILE().getProperty("de.unijena.bioinf.sirius.projectspace.formatter");
        ...
        final @NotNull SiriusProjectSpace space = create(formatter, location,
