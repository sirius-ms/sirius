...
public class SiriusCardLayout implements LayoutManager2,
        Serializable {
    /**
     ...
     */
    public SiriusCardLayout(int hgap, int vgap) {
        this.hgap = hgap;
        this.vgap = vgap;
    }
    ...
    public boolean isCardActive(int cardIndex) {
        return cardIndex == currentCard;
    }
    public boolean isCardActive(String cardName){
        return Objects.equals(vector.get(currentCard).name, cardName);
    }
    /**
