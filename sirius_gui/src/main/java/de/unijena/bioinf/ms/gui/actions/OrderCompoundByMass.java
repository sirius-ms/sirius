...
public class OrderCompoundByMass extends AbstractMainFrameAction {

    public OrderCompoundByMass(MainFrame mainFrame) {
        super("Order by mass", mainFrame);
    }

    @Override
    public void actionPerformed(ActionEvent e) {
        MF.getCompoundList().orderBy((o1, o2) -> {
