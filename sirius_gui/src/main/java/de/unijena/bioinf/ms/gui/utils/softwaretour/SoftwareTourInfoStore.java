...
public class SoftwareTourInfoStore {
    ...
    public static final String[] AllTourKeys = new String[] {MainFrameTourKey, BatchComputeTourKey, FormulaTabTourKey, FingerprintTabTourKey, CanopusTabTourKey, DatabaseSearchTabTourKey, DeNovoStructuresTabTourKey, EpimetheusTabTourKey};
    ...
    public static final SoftwareTourInfo LandingPage_CommunityInfo = new SoftwareTourInfo( "Interact with other SIRIUS users, ask questions or report bugs.", 1, LocationHorizontal.LEFT_SPACE_TO_LEFT,  LocationVertical.CENTER);
    ...
    public static final SoftwareTourInfo Fingerprint_Predictions = new SoftwareTourInfo("This displays all molecular properties (substructures) of the predicted fingerprint with probabilities.<br>Generally, the predicted fingerprint can be seen as an intermediate step for predicting compound classes or annotating the molecular structure.<br>Still, the fingerprint already contains a lot of structure information.<br>For some properties, examples are provided upon selection.", 2, LocationHorizontal.CENTER, LocationVertical.BELOW_BOTTOM);
    ...
    public static final SoftwareTourInfo DatabaseSearch_Rank = new SoftwareTourInfo("This is the rank of the structure candidate.<br>If multiple top candidates are highlighted green, this means they are structurally highly similar - the confidence score would consider any of this as top hit.<br>Green-highlighted rows in other result tabs all link to these top hits.", 2, LocationHorizontal.RIGHT_SPACE, LocationVertical.CENTER, DatabaseSearchTabTourKey);
    public static final SoftwareTourInfo DatabaseSearch_Source = new SoftwareTourInfo("The structure hit can be found in the displayed databases.<br>Even databases that have not been selected for search are displayed.", 3, LocationHorizontal.CENTER, LocationVertical.BELOW_BOTTOM, DatabaseSearchTabTourKey);
    ...
    public static final SoftwareTourInfo DeNovo_Filter = new SoftwareTourInfo("By default, molecular structures from database search are included in the list.<br>Toggle to (un-)hide those.", 2, LocationHorizontal.RIGHT_ALIGN, LocationVertical.BELOW_BOTTOM, DeNovoStructuresTabTourKey);
