...
public class QuantTable {
    ...
    /**
     * Names of the runs the objects are quantified in, in the order of columnIds.
     * <p>
     ...
     * it is not guaranteed to be unique. Use columnSources to identify the input file, and
     * columnIds to identify the run.
     */
    @Schema(nullable = true) protected String[] columnNames;

    /**
     * Files the runs were imported from, in the order of columnIds, to relate a column back to the input
