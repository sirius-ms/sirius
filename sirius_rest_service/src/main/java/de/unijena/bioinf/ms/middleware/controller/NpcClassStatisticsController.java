...
@RestController
@RequestMapping(value = "/api/projects/{projectId}/npc-classes/statistics")
@Tag(name = "NPC Class Statistics", description = "[EXPERIMENTAL] ...")
public class NpcClassStatisticsController implements CompoundClassStatisticsController<AlignedFeature> {
    ...
    @Autowired
    public NpcClassStatisticsController(ComputeService computeService, ProjectsProvider<?> projectsProvider) {
    ...
    public QuantRowType getTarget() {
        return QuantRowType.NPC_CLASSES;
    }

    @Operation(operationId = "computeNpcClassFoldChangesExperimental")
    @Override
    ...
    @Operation(operationId = "deleteNpcClassFoldChangesExperimental")
    @Override
    ...
    @Operation(operationId = "getNpcClassFoldChangeTableExperimental")
    @Override
