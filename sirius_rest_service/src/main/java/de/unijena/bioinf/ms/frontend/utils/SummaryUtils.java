...
public class SummaryUtils {
    ...
    public static CompoundClasses chooseBestNPCAssignments(@Nullable ProbabilityFingerprint npcClassification, @Nullable ProbabilityFingerprint cfClassification) {
