...
public class IdentitySearchSettings extends SpectralLibrarySearchSettings implements Ms2ExperimentAnnotation {
    ...
    public IdentitySearchSettings(boolean enabled, float minSimilarity, int minNumOfPeaks, int maxNumOfHits, SpectralMatchingType matchingType, Deviation precursorDeviation, Set<SpectrumType> targetTypes) {
    ...
    public static IdentitySearchSettings newInstance(
        ...
        return new IdentitySearchSettings(enabled, minSimilarity, minNumOfPeaks, maxNumOfHits, matchingType, precursorDeviation, targetTypes);
    }
}
