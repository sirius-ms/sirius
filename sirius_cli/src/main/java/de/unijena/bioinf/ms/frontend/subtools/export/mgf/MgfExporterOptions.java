...
public class MgfExporterOptions implements StandaloneTool<MgfExporterWorkflow> {
    ...
    @CommandLine.Option(names = "--feature-id", description = "If available use the feature ids from the input data instead of the SIRIUS internal id. The internal id will be used as a fallback if the given feature ids are not available or contain duplicates.", defaultValue = "true")
