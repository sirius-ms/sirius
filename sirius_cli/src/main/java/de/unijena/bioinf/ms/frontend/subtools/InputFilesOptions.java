...
public class InputFilesOptions {
    ...
    public static class CsvInput {
        @CommandLine.Option(names = {"-1", "--ms1"}, description = "MS1 spectra file names", paramLabel = "<ms1File>[,<ms1File>...]", order = 331)
        ...
        @CommandLine.Option(names = {"-2", "--ms2"}, description = "MS2 spectra file names", required = true, paramLabel = "<ms2File>[,<ms2File>...]", order = 332)
        ...
        @CommandLine.Option(names = {"-z", "--parentmass", "--precursor", "--mz"}, description = "the mass of the parent ion for specified ms2 spectra", required = true, order = 333)
        public Double parentMz;

        @CommandLine.Option(names = {"--ionization", "--adduct"}, description = "Specify the adduct for the corresponding Compound", defaultValue = "[M+?]+", showDefaultValue = CommandLine.Help.Visibility.ALWAYS, order = 334)
        ...
        @CommandLine.Option(names = {"-f", "--formula"}, description = "Specify the neutralized formula of this compound. This will be used for tree computation and no mass decomposition will be performed.", order = 335)
