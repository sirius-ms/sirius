...
public class CanopusSubToolJob extends InstanceJob {
    ...
    protected void computeAndAnnotateResult(final @NotNull Instance inst) throws Exception {
        ...
        Map<FormulaResult, WebJJob<CanopusJobInput, ?, CanopusResult, ?>> jobs = res.stream().collect(Collectors.toMap(r -> r, this::buildAndSubmitRemote));
    ...
    private WebJJob<CanopusJobInput, ?, CanopusResult, ?> buildAndSubmitRemote(@NotNull final FormulaResult ir) {
        try {
