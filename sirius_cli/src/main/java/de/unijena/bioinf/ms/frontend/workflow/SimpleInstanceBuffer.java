...
public class SimpleInstanceBuffer implements InstanceBuffer, JobSubmitter {
    ...
    public void start(final boolean invalidate) throws InterruptedException {
            ...
            while (instances.hasNext()) {
                ...
                { // calculate current throughput
                    ...
                    if ((snap - lastCheck) > 10) {
                        System.out.println("########################################");
                        System.out.println("## Computed " + snap + " instance. Current throughput: " + String.format("%,.2f", (snap / (w.getTime() / 1000d))) + " instances/second");
                        System.out.println("########################################");
                        lastCheck = snap;
                    }
                }
        ...
        System.out.println("########################################");
        System.out.println("## Computed " + instanceComputed.get() + " instances in " + w + "(" + String.format("%,.2f", (instanceComputed.get() / (w.getTime() / 1000d))) + " instances/second).");
        System.out.println("########################################");
    }
