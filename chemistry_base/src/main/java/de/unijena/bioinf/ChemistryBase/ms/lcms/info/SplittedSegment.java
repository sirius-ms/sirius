...
public abstract class SplittedSegment extends CompoundReport {
    ...
    public SplittedSegment(long splitRetentionTime) {
        this.splitRetentionTime = splitRetentionTime;
    }

    public long getSplitRetentionTime() {
        return splitRetentionTime;
    }

    @Override
    public String toString() {
        return "Segments are splitted at " + splitRetentionTime + " ms";
    }
}
