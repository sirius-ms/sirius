...
public class RejectedMsMsDueToChimeric extends RejectedMsMs{
    ...
    public RejectedMsMsDueToChimeric(long retentionTime, int scanId, float chimericPollution) {
    ...
    public String toString() {
        return super.toString() + " due to chimeric polution of " + (chimericPollution*100) + " % of precursor intensity" ;
    }
}
